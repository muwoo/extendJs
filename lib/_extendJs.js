...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__functions_uniqueArray__ = __webpack_require__(2);
/**
 * @author monkeywang
 * Date: 17/6/12
 */
...
for (let ObjExtend in extendJs) {
  if (extendJs.hasOwnProperty(ObjExtend)) {
    switch (ObjExtend) {
      case 'arrayExtend':
        extendArray(__WEBPACK_IMPORTED_MODULE_0__arrayExtend_index__["a" /* default */]);
        break;
    }
  }
}
